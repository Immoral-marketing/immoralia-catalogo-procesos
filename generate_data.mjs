...
const processes = [
  // 📣 Captación y Marketing
  {
    ...
    categoria: "CM",
    categoriaNombre: "Captación y Marketing",
  ...
  // 💼 Gestión Comercial / Ventas
  {
    ...
    categoria: "GV",
    categoriaNombre: "Gestión Comercial / Ventas",
  ...
  // ⚙️ Operaciones y Administración
  {
    id: "OA10",
    codigo: "OA10",
    slug: "alta-socio-accesos-auto",
    categoria: "OA",
    categoriaNombre: "Operaciones y Administración",
  ...
  // 👥 RRHH y Onboarding
  {
    ...
    categoria: "RO",
    categoriaNombre: "RRHH y Onboarding",
  ...
  // 💰 Finanzas y Facturación
  {
    ...
    categoria: "FF",
    categoriaNombre: "Finanzas y Facturación",
  ...
  // 🏋️ Operativa Específica del Sector
  {
    id: "OE29",
    codigo: "OE29",
    slug: "comunicacion-cambios-horario",
    categoria: "OE",
    categoriaNombre: "Operativa Específica",
