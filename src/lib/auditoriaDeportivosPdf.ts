  ...
  <div class="pg" style="padding:32px 40px 24px">
    <div style="background:linear-gradient(135deg,#041A1E,#020D10);color:#fff;padding:40px;border-radius:14px;margin-bottom:20px">
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap">
        <div style="padding:12px 24px;background:#06b6d4;color:#041A1E;border-radius:99px;font-weight:700;font-size:11px;letter-spacing:.5px">immoralia.es/procesos</div>
        <div style="padding:12px 24px;background:rgba(255,255,255,.08);color:#fff;border-radius:99px;font-weight:600;font-size:11px;letter-spacing:.3px;border:1px solid rgba(255,255,255,.15)">immoralia.es/procesos/sector/centros-deportivos</div>
      </div>
    </div>
