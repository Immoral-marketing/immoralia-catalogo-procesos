...
const sectors = [
  ...
  },
  {
    ...
    description: "Constructoras, arquitectura, reformas y empresas de mantenimiento.",
    icon: HardHat,
  ...
  },
  {
    ...
    number: "07",
    title: "Inmobiliarias",
    description: "Agencias inmobiliarias y empresas de gestión de propiedades.",
    icon: Home,
    path: "/sector/inmobiliaria",
    accent: "#059669",
    accentClass: "bg-emerald-600/10 border-emerald-600/25 text-emerald-400",
