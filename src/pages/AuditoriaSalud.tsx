      ...
      <nav className="border-b border-white/5 bg-black/60 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <button
            ...
            className="text-sm text-gray-400 hover:text-blue-300 transition-colors flex items-center gap-1.5"
          >
        ...
        <div className="sticky top-[65px] z-40 bg-[#0d0d0d]/95 backdrop-blur-md border-b border-white/5">
          <div className="container mx-auto px-6 py-3">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <span className="text-[11px] tracking-widest uppercase text-blue-400">
...
const IntroScreen = ({ onStart }: { onStart: () => void }) => (
  <section className="relative py-24 md:py-32 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/8 via-transparent to-blue-700/8 pointer-events-none" />
    <div className="absolute top-1/3 left-0 -translate-y-1/2 w-96 h-96 bg-blue-500/10 blur-[140px] rounded-full pointer-events-none" />
    <div className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-blue-700/8 blur-[160px] rounded-full pointer-events-none" />
    ...
    <div className="container mx-auto px-6 relative z-10">
      <div className="max-w-3xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 mb-7">
          ...
          <span className="text-blue-300 font-medium tracking-widest uppercase text-[11px]">
        ...
        <div className="flex flex-wrap gap-2.5 justify-center mb-10">
          {[
            ...
            return (
              ...
              >
                <Icon className="w-3.5 h-3.5 text-blue-400" /> {it.label}
              </div>
            );
          })}
        </div>
        ...
        <Button
          size="lg"
          onClick={onStart}
          className="bg-blue-600 hover:bg-blue-500 text-white h-16 px-10 text-lg gap-2 font-bold shadow-lg shadow-blue-900/40 transition-all hover:scale-[1.02]"
        >
      ...
      <div className="max-w-4xl mx-auto mt-24 grid grid-cols-1 md:grid-cols-3 gap-5">
        {[
          ...
          <div
            key={it.n}
            className="p-6 rounded-2xl border border-white/8 bg-white/[0.02] hover:bg-white/[0.04] hover:border-blue-500/20 transition-all"
          >
            <div className="text-blue-400 text-xs tracking-widest font-bold mb-3">{it.n}</div>
  ...
  <section className="py-12 md:py-20">
    <div className="container mx-auto px-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-blue-400 text-[11px] tracking-widest font-bold uppercase mb-3">
          {q.cat}
        </div>
              ...
              return (
                <button
                  ...
                  className={`group text-left p-4 rounded-xl border transition-all flex items-center gap-4 ${
                    selected
                      ? "bg-blue-500/10 border-blue-500/50 shadow-[0_0_24px_rgba(20,184,166,0.18)]"
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] md:text-[11px] uppercase tracking-wider leading-tight text-center ${
                        selected ? "text-blue-300" : "text-gray-500 group-hover:text-gray-300"
                      }`}
                    >
                      {lbl}
                    </span>
        ...
        <div className="flex justify-between items-center gap-3 mt-8 pt-6 border-t border-white/5">
          ...
          <Button
            onClick={onNext}
            disabled={!canAdvance}
            className="bg-blue-600 hover:bg-blue-500 text-white disabled:bg-white/10 disabled:text-gray-500 gap-2 font-semibold"
          >
    ...
    <div className="container mx-auto px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-between items-center gap-3 mt-10 pt-6 border-t border-white/5">
          ...
          <Button
            onClick={onFinish}
            className="bg-blue-600 hover:bg-blue-500 text-white gap-2 font-semibold h-12 px-6"
          >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <Button
              onClick={onDownload}
              disabled={pdfBusy}
              className="bg-blue-600 hover:bg-blue-500 text-white h-14 px-7 text-base gap-2 font-bold shadow-lg shadow-blue-900/30 transition-all hover:scale-[1.02]"
            >
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#041a1a] to-[#071f1f] p-8 md:p-12 mb-6 grid grid-cols-1 md:grid-cols-[240px_1fr] gap-10 items-center">
            <div className="relative w-[200px] h-[200px] mx-auto">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-6xl font-bold text-blue-400 leading-none">
                  {result.global}
                </span>
            ...
            <div className="text-center md:text-left">
              <div className="text-blue-300 text-[11px] tracking-widest uppercase font-bold mb-2">
          ...
          <div className="rounded-3xl border border-white/8 bg-white/[0.02] p-7 md:p-8 mb-6">
            <div className="text-blue-400 text-[11px] tracking-widest font-bold uppercase mb-5">
            ...
            <div className="grid gap-3.5">
              {SA_AUDIT_BLOCK_KEYS.map((b) => {
                ...
                const color =
                  sc < 40 ? "bg-red-500" : sc < 70 ? "bg-blue-700" : "bg-blue-400";
                const textColor =
                  sc < 40 ? "text-red-400" : sc < 70 ? "text-blue-500" : "text-blue-400";
                return (
                  <div
                    key={b}
                    className="grid grid-cols-[48px_1fr_72px] gap-4 items-center p-4 rounded-xl bg-white/[0.02] border border-white/5"
                  >
                    <div className="w-12 h-12 rounded-full bg-[#071a1a] border border-blue-500/30 flex items-center justify-center">
          ...
          <div className="rounded-3xl border border-white/8 bg-white/[0.02] p-7 md:p-8 mb-6">
            <div className="text-blue-400 text-[11px] tracking-widest font-bold uppercase mb-1">
            ...
            <div className="grid gap-3.5">
              {modules.map((m, i) => (
                <div
                  key={i}
                  className="p-5 rounded-2xl border-l-4 border-blue-500 bg-white/[0.02] border-t border-r border-b border-white/5"
                >
                  <div className="text-[10px] tracking-widest text-blue-400 font-bold uppercase mb-1">
                  ...
                  <span className="inline-block px-3 py-1 rounded-full bg-blue-500/10 text-blue-300 text-[10px] uppercase tracking-widest font-bold border border-blue-500/20">
                    {m.impact}
                  </span>
                </div>
              ))}
          ...
          {/* CTA final */}
          <div className="rounded-3xl bg-gradient-to-br from-[#071a1a] to-[#041414] border border-blue-500/20 p-8 md:p-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center justify-center gap-2 px-7 h-12 rounded-full bg-blue-500 text-white font-bold hover:bg-blue-400 transition-all"
              >
