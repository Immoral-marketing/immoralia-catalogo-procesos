...
const IntroScreen = ({ onStart }: { onStart: () => void }) => (
  <section className="relative py-24 md:py-32 overflow-hidden">
    ...
    <div className="absolute top-1/3 left-0 -translate-y-1/2 w-96 h-96 bg-cyan-500/10 blur-[140px] rounded-full pointer-events-none" />
    <div className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-cyan-700/8 blur-[160px] rounded-full pointer-events-none" />
    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-white/8 bg-white/[0.02] p-7 md:p-8 mb-6">
            ...
            <div className="grid gap-3.5">
              {DP_AUDIT_BLOCK_KEYS.map((b) => {
                ...
                const textColor =
                  sc < 40 ? "text-red-400" : sc < 70 ? "text-cyan-500" : "text-cyan-400";
                return (
                  <div
                    key={b}
                    className="grid grid-cols-[48px_1fr_72px] gap-4 items-center p-4 rounded-xl bg-white/[0.02] border border-white/5"
                  >
                    <div className="w-12 h-12 rounded-full bg-[#041A1E] border border-cyan-500/30 flex items-center justify-center">
          ...
          {/* CTA final */}
          <div className="rounded-3xl bg-gradient-to-br from-[#041A1E] to-[#020D10] border border-cyan-500/20 p-8 md:p-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center justify-center gap-2 px-7 h-12 rounded-full bg-cyan-500 text-white font-bold hover:bg-cyan-400 transition-all"
              >
