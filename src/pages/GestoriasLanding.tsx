  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-teal-500/30">
        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Button 
              ...
              className="text-sm text-teal-400 hover:text-teal-300 hover:bg-teal-500/5 hidden md:flex items-center gap-2"
            >
            ...
            <Button onClick={scrollToProcesses} className="bg-teal-600 hover:bg-teal-500 text-white border-none shadow-[0_0_20px_rgba(20,184,166,0.2)]">
              Ver Soluciones
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-teal-900/10 blur-[120px] rounded-full -z-10" />
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-lg font-bold text-teal-400">{selectedProcessIds.size} procesos</p>
              </div>
              <Button 
                onClick={() => setShowContactForm(true)}
                disabled={selectedProcessIds.size === 0}
                className="bg-teal-600 hover:bg-teal-500 disabled:bg-gray-800 h-12 px-6 shadow-lg shadow-teal-900/20 transition-all active:scale-95"
              >
      ...
      {selectedProcessIds.size > 0 && (
        <Sheet>
          <SheetTrigger asChild>
            <Button
              className="fixed bottom-8 left-8 z-50 h-14 pl-4 pr-6 rounded-full bg-teal-600 hover:bg-teal-500 shadow-[0_0_20px_rgba(20,184,166,0.4)] border-none group transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-left-4"
            >
              <div className="flex items-center gap-3">
                <div className="relative">
                  <LayoutGrid className="w-6 h-6 text-white" />
                  <span className="absolute -top-2 -right-2 bg-white text-teal-600 text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center border border-teal-600">
      ...
      <OnboardingModal
        ...
        prefilledSector={process.env.NODE_ENV === 'production' ? 'Gestoría' : 'Gestoria'}
      />
    </div>
  );
};
