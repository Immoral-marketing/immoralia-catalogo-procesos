                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex items-center justify-between mb-6">
                      <div className="font-bold text-lg">
                        ...
                        <span className="text-sky-400">moralia</span>
                      </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
              <div className="max-w-2xl">
                ...
                <p className="text-gray-400 leading-relaxed text-justify hyphens-auto">
                  Las 21 fichas detalladas de cada proceso, agrupadas por bloque. Filtra por bloque o busca por nombre para abrir la ficha completa.
                </p>
              </div>
