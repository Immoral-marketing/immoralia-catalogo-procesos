    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-rose-500/30 font-sans">
      ...
      <nav className="border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button onClick={scrollToProcesses} className="bg-rose-600 hover:bg-rose-500 text-white border-none font-bold">
              Ver Soluciones
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-medium mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Users className="w-3 h-3 text-rose-400" /> ESPECIAL AGENCIAS & CONSULTORÍA
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <Button size="lg" onClick={scrollToProcesses} className="bg-rose-600 hover:bg-rose-500 text-white h-14 px-8 text-lg gap-2 font-bold shadow-lg shadow-rose-900/20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="flex gap-4 p-6 rounded-2xl bg-black/40 border border-white/5 hover:border-rose-500/20 transition-colors group">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div className="max-w-2xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-rose-400 font-medium">CATÁLOGO ESPECIALIZADO</span>
                </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
                ...
                <Button 
                  ...
                  className="bg-rose-600 hover:bg-rose-500 disabled:bg-gray-800 h-12 px-6 font-bold"
                >
      ...
      <section className="py-24 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-3xl font-bold mb-12 text-center text-rose-400">Preguntas Frecuentes</h2>
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-rose-600/10 -z-10" />
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => setShowContactForm(true)} className="bg-rose-600 hover:bg-rose-500 h-16 px-10 text-xl font-bold shadow-[0_0_40px_rgba(225,29,72,0.3)]">
