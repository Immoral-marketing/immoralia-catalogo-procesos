...
const RestauracionLanding = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Immoralia - Catálogo de Procesos - Gastronomía y Hotelería";
    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-orange-500/30 font-sans">
      ...
      <footer className="py-12 border-t border-white/5 bg-black/50">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-sm">© 2026 Immoralia. Soluciones de Automatización para Gastronomía y Hotelería.</p>
        </div>
      </footer>
      ...
      <OnboardingModal
        ...
        prefilledSector="Gastronomía y Hotelería"
        accentColor="#ea580c"
      />
