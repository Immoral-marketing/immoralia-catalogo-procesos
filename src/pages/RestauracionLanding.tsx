...
const RestauracionLanding = () => {
  ...
  const [activeCategory, setActiveCategory] = useState(restauracionCategories[0]?.id || "");
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-orange-500/30 font-sans">
      ...
      <nav className="border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button onClick={scrollToProcesses} className="bg-orange-600 hover:bg-orange-500 text-white border-none font-bold">
              Ver Soluciones
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-orange-900/10 blur-[120px] rounded-full -z-10" />
        <div className="container mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-medium mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Utensils className="w-3 h-3 text-orange-400" /> ESPECIAL RESTAURACIÓN & HOSTELERÍA
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <Button size="lg" onClick={scrollToProcesses} className="bg-orange-600 hover:bg-orange-500 text-white h-14 px-8 text-lg gap-2 font-bold shadow-lg shadow-orange-900/20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="flex gap-4 p-6 rounded-2xl bg-black/40 border border-white/5 hover:border-orange-500/20 transition-colors group">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="text-center space-y-4">
                <div className="mx-auto w-16 h-16 rounded-2xl bg-orange-500/10 flex items-center justify-center border border-orange-500/20">
                  {prop.icon}
                </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div className="max-w-2xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-orange-400 font-medium">CATÁLOGO ESPECIALIZADO</span>
                </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-lg font-bold text-orange-400">{selectedProcessIds.size} procesos</p>
                </div>
                <Button 
                  onClick={() => setShowContactForm(true)}
                  disabled={selectedProcessIds.size === 0}
                  className="bg-orange-600 hover:bg-orange-500 disabled:bg-gray-800 h-12 px-6 font-bold"
                >
      ...
      <section className="py-24 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-3xl font-bold mb-12 text-center text-orange-400">Preguntas Frecuentes</h2>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => setShowContactForm(true)} className="bg-orange-600 hover:bg-orange-500 h-16 px-10 text-xl font-bold shadow-[0_0_40px_rgba(234,88,12,0.3)]">
      ...
      {selectedProcessIds.size > 0 && (
        <Sheet>
          <SheetTrigger asChild>
            <Button
              className="fixed bottom-8 left-8 z-50 h-14 pl-4 pr-6 rounded-full bg-orange-600 hover:bg-orange-500 shadow-[0_0_20px_rgba(234,88,12,0.4)] border-none group transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-left-4"
            >
              <div className="flex items-center gap-3">
                <div className="relative">
                  <LayoutGrid className="w-6 h-6 text-white" />
                  <span className="absolute -top-2 -right-2 bg-white text-orange-600 text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center border border-orange-600">
