        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Button 
              ...
              className="text-sm text-orange-400 hover:text-orange-300 hover:bg-orange-500/5 hidden md:flex items-center gap-2"
            >
            ...
            <Button onClick={scrollToProcesses} className="bg-orange-600 hover:bg-orange-500 text-white border-none font-bold shadow-[0_0_20px_rgba(234,88,12,0.2)]">
              Ver Soluciones
            </Button>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
                ...
                <Button 
                  ...
                  className="bg-orange-600 hover:bg-orange-500 disabled:bg-gray-800 h-12 px-6 font-bold shadow-lg shadow-orange-900/20 transition-all active:scale-95"
                >
