...
const InmobiliariaLanding = () => {
  ...
  const [activeCategory, setActiveCategory] = useState(inmobiliariaCategories[0]?.id || "");
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-lg font-bold text-emerald-400">{selectedProcessIds.size} procesos</p>
                </div>
                <Button 
            ...
            >
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <span className="absolute -top-2 -right-2 bg-white text-emerald-600 text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center border border-emerald-600">
