...
const ConstruccionLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-yellow-500/30 font-sans">
                ...
                <Button
                  className={`relative h-10 px-4 gap-2 border transition-all ${
                    selectedProcessIds.size > 0
                      ? "bg-yellow-600 hover:bg-yellow-500 text-white border-yellow-600 shadow-[0_0_20px_rgba(234,179,8,0.2)]"
        ...
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="flex flex-col items-center gap-5 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <Button
              ...
              className="bg-yellow-600 hover:bg-yellow-600 text-white h-14 px-8 text-lg gap-2 font-bold shadow-lg shadow-yellow-900/30 transition-all hover:scale-[1.02]"
            >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-5 tracking-tight">
              ...
              <span className="text-yellow-400">puede vender más, mejor y con menos esfuerzo</span>
            </h2>
      ...
      <section id="diagnostico" className="py-28 relative overflow-hidden bg-[#100e02]">
        {/* Top border glow */}
        <div className="audit-border absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-yellow-500/60 to-transparent" />
        {/* Grid background */}
        ...
        <div className="audit-orb-1 absolute top-1/2 -left-40 w-[700px] h-[700px] bg-yellow-600/35 blur-[160px] rounded-full pointer-events-none" />
        {/* Secondary orb — right top */}
        <div className="audit-orb-2 absolute -top-20 right-0 w-[500px] h-[500px] bg-yellow-400/22 blur-[120px] rounded-full pointer-events-none" />
        {/* Bottom center glow */}
        <div className="audit-orb-3 absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[180px] bg-yellow-500/18 blur-[80px] rounded-full pointer-events-none" />
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center bg-yellow-600 hover:bg-yellow-600 text-white h-14 px-7 text-base gap-2 font-bold rounded-md shadow-lg shadow-yellow-900/30 transition-all hover:scale-[1.02]"
                >
                ...
                <div className="relative rounded-2xl border border-white/20 bg-[#0d2a1a] overflow-hidden shadow-2xl shadow-black/60">
                  <div className="p-6 md:p-8">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="text-[10px] tracking-widest text-yellow-300/80 uppercase">
                        Confidencial
                      </span>
                    </div>
                    <div className="text-xs tracking-widest text-yellow-300/80 mb-3 uppercase">
                    ...
                    <div className="flex items-center gap-5 mb-6 py-4 border-y border-white/10">
                      <div className="relative w-20 h-20 rounded-full bg-[#1a1600] border-2 border-yellow-400/30 flex flex-col items-center justify-center">
                        <span className="text-3xl font-bold text-yellow-400 leading-none">68</span>
        ...
        <div className="container mx-auto px-6 text-center max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              onClick={() => setShowContactForm(true)}
              className="bg-yellow-600 hover:bg-yellow-600 h-16 px-10 text-xl font-bold shadow-[0_0_40px_rgba(234,179,8,0.3)] transition-all hover:scale-105"
            >
              Solicitar propuesta
            </Button>
            <Button
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-3 duration-300 px-4 w-full max-w-lg">
          <div className="flex items-center gap-4 px-5 py-3.5 rounded-2xl bg-[#171717] border border-yellow-500/30 shadow-2xl shadow-black/70 backdrop-blur-md">
            ...
            <Button
              size="sm"
              onClick={() => setShowContactForm(true)}
              className="bg-yellow-600 hover:bg-yellow-600 text-white h-9 px-4 text-sm font-semibold gap-1.5 shrink-0"
            >
