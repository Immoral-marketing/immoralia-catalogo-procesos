            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
              <div className="max-w-2xl">
                ...
                <p className="text-gray-400 leading-relaxed text-justify hyphens-auto">
                  Las fichas detalladas de cada proceso, agrupadas por bloque. Filtra por bloque o busca por nombre para abrir la ficha completa.
                </p>
              </div>
              ...
              <TabsContent value={activeBlockTab} className="mt-0">
                {filteredCatalog.length === 0 ? (
                  <div className="text-center py-16 text-gray-500">
                    No hay procesos que coincidan con tu búsqueda en este bloque.
                  </div>
                ) : (
