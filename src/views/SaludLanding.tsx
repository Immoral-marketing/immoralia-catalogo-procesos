    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white selection:bg-sky-500/30 font-sans">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('${withBasePath('/salud/hero.webp')}'), url('${withBasePath('/salud-hero.jpg')}')` }}
        />
      ...
      <section id="auditoria" className="py-28 relative overflow-hidden bg-[#060c18]">
        {/* Top border glow */}
        <div className="audit-border absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-sky-500/60 to-transparent" />
        {/* Grid background */}
        ...
        <div className="audit-orb-1 absolute top-1/2 -left-40 w-[700px] h-[700px] bg-sky-600/35 blur-[160px] rounded-full pointer-events-none" />
        {/* Secondary orb — right top */}
        <div className="audit-orb-2 absolute -top-20 right-0 w-[500px] h-[500px] bg-sky-400/22 blur-[120px] rounded-full pointer-events-none" />
        {/* Bottom center glow */}
        <div className="audit-orb-3 absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[180px] bg-sky-500/18 blur-[80px] rounded-full pointer-events-none" />
                  ...
                  >
                    ...
                    {b.id === "B1" && (
                      ...
                      >
                        <video
                          ref={videoRef}
                          src={withBasePath("/salud/modulo1.mp4")}
