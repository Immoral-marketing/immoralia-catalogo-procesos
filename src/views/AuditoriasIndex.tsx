...
const AUDITS: SectorAudit[] = [
  ...
  },
  {
    ...
    short: "Fábricas y empresas de producción: metalurgia, alimentación, química, electrónica y más",
    icon: Factory,
    path: "/auditorias/industrial",
    status: "available",
    color: "yellow",
    accent: "from-yellow-500/30 to-amber-600/30",
    bullets: [
      "Presupuestos automáticos y cierre del puente comercial a planta",
      "Trazabilidad por lote y gestión de no conformidades sin papeles",
      "Mantenimiento preventivo, turnos individuales y cobros en piloto automático",
    ],
  },
  {
    id: "academias",
