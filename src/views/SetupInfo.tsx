                    ...
                    <div className="container mx-auto px-6 md:px-8 lg:px-12 py-4 md:py-6">
                        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <Image src={immoraliaLogo} alt="Immoralia" width={160} height={40} className="h-8 md:h-10 w-auto pl-2" />
                            </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <nav className="mb-8 hidden md:block">
                            <ol className="flex text-sm text-muted-foreground gap-2">
                                <li className="hover:text-foreground cursor-pointer" onClick={() => router.push("/")}>Catálogo</li>
                                <li>/</li>
                        ...
                        <section className="mb-20 grid lg:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Donde vive tu automatización</h1>
                                <p className="text-xl text-muted-foreground font-light leading-relaxed">
                                    Para que tus procesos funcionen solos, necesitan una "casa" encendida 24/7.
                                </p>
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className="cursor-help">
                                                        ...
                                                        <span className="text-xs font-bold block mt-1">El Motor</span>
                                                    </div>
                                                </TooltipTrigger>
                                                <TooltipContent>
                                                    <p>n8n: La herramienta que ejecuta tus automatizaciones.</p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                        <div className="h-px bg-primary/30 flex-1 relative">
                        ...
                        <div className="space-y-32">
                            <section id="que-es" className="scroll-mt-40 space-y-12">
                                <div className="max-w-3xl mx-auto text-center space-y-4">
                                    <h2 className="text-3xl font-bold">¿Qué es el "Motor" de Automatización?</h2>
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <Card className="p-8 bg-primary/5 border-primary/20 space-y-4">
                                        ...
                                        <p className="text-foreground leading-relaxed">
                                            "Es la herramienta que conecta tus aplicaciones (correo, CRM, facturación…) para que trabajen solas."
                                        </p>
                                    </Card>
                                    ...
                                    <Card className="p-8 bg-secondary/5 border-secondary/20 space-y-4">
                                        ...
                                        <p className="text-foreground leading-relaxed">
                                            "Para que eso pase, el motor debe estar instalado en un servidor que esté encendido todo el día (como un ordenador en internet)."
                                        </p>
                                    </Card>
                                </div>
                                ...
                                <div className="bg-muted/30 rounded-2xl p-8 border border-border text-center">
                                    <div className="text-muted-foreground flex items-center justify-center gap-1 flex-wrap">
                                        <Tooltip>
                                            <TooltipTrigger className="font-bold text-foreground decoration-primary/30 underline underline-offset-4 cursor-help">
                                                VPS
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>Virtual Private Server: Tu propio ordenador en la nube.</p>
                                            </TooltipContent>
                                        </Tooltip>
                                        <span>= Es simplemente un servidor en internet (una "máquina" siempre encendida) donde vive tu automatización.</span>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section id="opciones" className="scroll-mt-40 space-y-12">
                                    ...
                                    <Card className={cn(
                                        ...
                                        <div className="space-y-6 flex-1">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="text-2xl font-bold">Gestionado por Immoralia</h3>
                                                    <p className="text-sm text-primary font-medium">Nosotros nos encargamos de todo</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <ul className="grid gap-2 text-sm bg-muted/50 p-4 rounded-xl border border-border">
                                                    <li className="flex gap-2"><span>•</span> Instalamos y configuramos el motor.</li>
                                    ...
                                    <Card className={cn(
                                        ...
                                        <div className="space-y-6 flex-1">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="text-2xl font-bold">Servidor propio</h3>
                                                    <p className="text-sm text-muted-foreground font-medium">Gestión avanzada por tu parte</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <ul className="grid gap-2 text-sm bg-muted/50 p-4 rounded-xl border border-border">
                                                    <li className="flex gap-2"><span>•</span> Acceso al servidor o al motor existente.</li>
                                ...
                                <div className="max-w-xl mx-auto bg-primary/10 border border-primary/30 p-6 rounded-2xl text-center space-y-3">
                                    ...
                                    <p className="text-sm">
                                        "Si no sabes qué es un servidor o no tienes a quién preguntarle, elige <span className="font-bold italic underline">Gestionado por Immoralia</span>. Es la forma más rápida y segura de empezar."
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="que-incluye" className="scroll-mt-40 space-y-12">
                                ...
                                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                    {[
                                        { icon: Zap, title: "Instalación", desc: "Puesta en marcha y configuración inicial del motor." },
                                ...
                                <div className="grid lg:grid-cols-2 gap-12 items-center">
                                    <div className="space-y-8">
                                        ...
                                        <div className="grid gap-6">
                                            {[
                                                { title: "Acceso protegido", desc: "Solo tú y las personas autorizadas pueden acceder al sistema." },
                                        ...
                                        <div className="bg-card border border-border rounded-2xl p-8 space-y-6">
                                            ...
                                            <Accordion type="single" collapsible className="w-full">
                                                ...
                                                <AccordionItem value="item-2" className="border-border">
                                                    ...
                                                    <AccordionContent className="text-xs text-muted-foreground leading-relaxed">
                                                        Servidores Linux de alta disponibilidad, optimizados específicamente para entornos Node.js y ejecución de flujos de trabajo.
                                                    </AccordionContent>
                                                </AccordionItem>
                                            </Accordion>
                                        </div>
                            ...
                            <section id="faqs" className="scroll-mt-40 space-y-12">
                                ...
                                <div className="max-w-3xl mx-auto bg-card border border-border rounded-2xl overflow-hidden">
                                    <Accordion type="single" collapsible className="w-full">
                                        {[
                                            { q: "¿Necesito tener un servidor?", a: "Si eliges 'Gestionado por Immoralia', no. Nosotros nos ocupamos de todo. Si prefieres usar el tuyo, sí necesitarás un servidor (VPS) compatible." },
                                            ...
                                            { q: "¿Mis datos están seguros?", a: "Totalmente. El motor corre en un entorno aislado y encriptado. No mezclamos datos de clientes y aplicamos capas de seguridad robustas." },
                                            { q: "¿Quién paga el servidor si es autoalojado?", a: "En la opción 'Gestionado por Immoralia', el coste del servidor ya está incluido en la cuota de mantenimiento que pactemos. En la opción propia, tú pagas a tu proveedor de servidores." }
                                        ].map((faq, i) => (
                        ...
                        <section className="mt-32 pt-20 border-t border-border text-center space-y-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                <Button size="lg" className="px-8 py-8 text-lg font-bold shadow-xl shadow-primary/20" onClick={() => router.push("/")}>
